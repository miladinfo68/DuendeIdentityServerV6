...
builder.Services.AddDbContextPool<ApplicationDbContext>((serviceProvider, dbContextOptionsBuilder) =>
{
...
if (app.Environment.IsDevelopment())
{
    ...
    if (await userManager.FindByEmailAsync("milad@test.com") is null)
    {
